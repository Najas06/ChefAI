...
const UserProfileMain = () => {
  return (
    ...
    className='mt-10 mx-6'>
      <div>
        <div className='flex justify-between items-center'>
          ...
          <div className='flex justify-center items-center gap-2 max-md:hidden max-sm:hidden'>
            <button className='text-[#fff] bg-[#2a373e] hover:text-[#ff725e] transition duration-150  font-semibold rounded-lg px-3 py-2 flex items-center gap-1'>Profile Edit <BiPen/></button>
            <button className='text-[#fff] bg-[#ff725e] hover:text-[#2a373e] transition duration-150 font-semibold  rounded-lg px-3 py-2 flex items-center gap-1'>Add Recipe <FaBowlFood /></button>
          </div>
        </div>
      ...
      <img src={userWave} alt="" className='mt-10 w-full -mb-3' />
    </>
  )
}
